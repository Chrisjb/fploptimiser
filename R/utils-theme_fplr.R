theme_fplr <- function (base_family = "Arial", base_size = 10, plot_title_family = base_family,
                       plot_title_size = 16, plot_title_face = "bold", plot_title_margin = 10,
                       subtitle_family = "Arial", subtitle_size = 12, subtitle_face = "plain",
                       subtitle_margin = 15, strip_text_family = base_family, strip_text_size = 11,
                       strip_text_face = "plain", caption_family = "Arial",
